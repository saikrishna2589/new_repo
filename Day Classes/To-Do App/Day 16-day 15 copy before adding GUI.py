...
import time # This is standard module in python . function module below is local module as we created it
now = time.strftime("%d-%b-%Y %I:%M:%S %p")
print("Time and Date now when i am learning and doing Python course is:",now)
