...
def get_todo_list(filepath="../../Day Classes/To-Do App/To_do_list.txt"):
...
Multiline_Strings = #here for multiline string example using triple quotes- you dont need to provide breaklines
#Text would display the same way as in the variable as below.
"""This function open the file in the filepath provided ,read all the lines and saves it as a list in a variable
        and returns the list as the output
        """
