...
while True:
    ...
    if "add" in user_display or "new" in user_display:  # using if instead of match case to have flexibility to
        # contain the keywords into the task entry.This can't be done using match-case.
        # adding boolean operators for further options for users# ('or, 'and' and 'not')
        ...
        with open("../../Day Classes/To-Do App/To_do_list.txt", 'r') as file:
        ...
        with open("../../Day Classes/To-Do App/To_do_list.txt", 'w') as file2:
    ...
    # will need to use f-strings
        ...
        with open("../../Day Classes/To-Do App/To_do_list.txt", 'r') as read_todo_list:
        ...
        with open("../../Day Classes/To-Do App/To_do_list.txt", 'w') as file3:
    ...
    # we need to think about 'METHODS'
        ...
        with open("../../Day Classes/To-Do App/To_do_list.txt", 'r') as file_complete:
        ...
        with open("../../Day Classes/To-Do App/To_do_list.txt", 'w') as file_complete1:
