...
def get_todo_list(filepath):
    filepath = "../../Day Classes/To-Do App/To_do_list.txt1"
...
def write_to_do_list(filepath_local, to_do_list_local):
...
while True:
    ...
    if user_display.startswith("add"):
        ...
        To_do_list = get_todo_list("../../Day Classes/To-Do App/To_do_list.txt")
        ...
        write_to_do_list("../../Day Classes/To-Do App/To_do_list.txt", To_do_list)
